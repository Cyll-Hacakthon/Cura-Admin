...
import Logo from "../../assests/LogoNurse.png";
import { UserOutlined, LogoutOutlined } from "@ant-design/icons";
import { signOut } from "../../store/actions/authAction";
import { connect } from "react-redux";

//Dashboard content
import Preconsultation from "../Nurse/Preconsultation";

class DashboardNurse extends Component {
  state = {
    selectedMenu: 0,
  };
    ...
    return (
      <LeftNavBar mode="inline">
        ...
        <Menu.Item key="0" onClick={this.handleNavigation.bind(this, "List")}>
          ...
          <ButtonText>Preconsultation</ButtonText>
        </Menu.Item>
...
export default connect(null, mapDispatchToProps)(DashboardNurse);
